@doc raw"""
    spike_train_spectrum_power(spks::Vector{T}, f::T; t_len=1) where {T <: AbstractFloat}
...
"""
function spike_train_spectrum_power(spks::Vector{T}, f::T; t_len=1) where {T <: AbstractFloat}
    ω = T(2 * pi * f)
